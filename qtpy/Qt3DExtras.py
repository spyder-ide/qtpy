...
if PYQT5:
    try:
        ...
        raise QtModuleNotInstalledError(name='Qt3DExtras', binding=API_NAME, missing_package='PyQt3D')
elif PYQT6:
    try:
        from PyQt6.Qt3DExtras import *
    except ModuleNotFoundError as error:
        raise QtModuleNotInstalledError(name='Qt3DExtras', binding=API_NAME, missing_package='PyQt6-3D')
elif PYSIDE2:
