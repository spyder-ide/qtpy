...
PySide2, PySide6, PyQt4 and finally PySide); in that case, you can force the use of one
...
initial_api = API
assert API in (PYQT5_API + PYQT6_API + PYQT4_API + PYSIDE_API + PYSIDE2_API + PYSIDE6_API)
...
API_NAME = {'pyqt6': 'PyQt6', 'pyqt5': 'PyQt5', 'pyqt': 'PyQt4', 'pyqt4': 'PyQt4',
